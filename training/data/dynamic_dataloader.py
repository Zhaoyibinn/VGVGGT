...
class DynamicTorchDataset(ABC):
    def __init__(
        ...
        max_scenes_per_gpu: int | None = None,
    ) -> None:
        ...
        self.fixed_scene_images = bool(getattr(common_config, "fixed_scene_images", False))
        self.expected_scene_image_count = int(getattr(common_config, "expected_scene_image_count", -1))
        if self.fixed_scene_images:
            ...
            self.image_num_range = [self.expected_scene_image_count, self.expected_scene_image_count]
    ...
    def get_loader(self, epoch):
        ...
        # Set the epoch for the sampler and the dynamic batch schedule
...
class DynamicBatchSampler(Sampler):
    ...
    def __init__(self,
        ...
        Args:
            ...
            max_scenes_per_gpu: Optional upper bound on the number of scenes in one batch.
        """
    ...
    def __iter__(self):
        ...
        while True:
            try:
                ...
                if self.max_scenes_per_gpu is not None:
                    batch_size = min(batch_size, self.max_scenes_per_gpu)
    ...
    def __len__(self):
        ...
        return len(self.sampler)  # You can customize this if needed
