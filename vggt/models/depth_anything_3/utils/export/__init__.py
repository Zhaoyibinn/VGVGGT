...
from vggt.models.depth_anything_3.utils.export.gs import export_to_gs_ply, export_to_gs_video
...
def export(
    ...
    **kwargs,
    ...
    if export_format == "glb":
        ...
        export_to_gs_ply(prediction, export_dir, conf_thresh_percentile = kwargs.get("glb", {})['conf_thresh_percentile'])
