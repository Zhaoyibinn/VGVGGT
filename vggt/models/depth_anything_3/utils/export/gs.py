...
from vggt.models.depth_anything_3.model.utils.gs_renderer import run_renderer_in_chunk_w_trj_mode
from vggt.models.depth_anything_3.specs import Prediction
from vggt.models.depth_anything_3.utils.export.glb import get_conf_thresh
from vggt.models.depth_anything_3.utils.gsply_helpers import save_gaussian_ply
from vggt.models.depth_anything_3.utils.layout_helpers import hcat, vcat
from vggt.models.depth_anything_3.utils.visualize import vis_depth_map_tensor
...
def export_to_gs_ply(
    ...
    # conf_mask_dir = Path(export_dir) / "gs_ply" / "conf_mask"
    ...
    if prediction.conf is not None:
        # os.makedirs(conf_mask_dir, exist_ok=True)
        ...
        conf_mask = prediction.conf >= conf_thr
