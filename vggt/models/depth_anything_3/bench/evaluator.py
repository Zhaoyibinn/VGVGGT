...
from vggt.models.depth_anything_3.bench.print_metrics import MetricsPrinter
from vggt.models.depth_anything_3.utils.parallel_utils import parallel_execution
from vggt.models.depth_anything_3.bench.registries import MV_REGISTRY
from vggt.models.depth_anything_3.utils.constants import EVAL_REF_VIEW_STRATEGY
...
class Evaluator:
    ...
    def _compute_pose_with_gt(self, result_path: str, gt_meta: Dict) -> TDict[str, float]:
        ...
        """
        from vggt.models.depth_anything_3.bench.dataset import _wait_for_file_ready
        from vggt.models.depth_anything_3.bench.utils import compute_pose
        from vggt.models.depth_anything_3.utils.geometry import as_homogeneous
...
if __name__ == "__main__":
    ...
    from vggt.models.depth_anything_3.cfg import load_config
  ...
  python -m depth_anything_3.bench.evaluator eval.print_only=true
    ...
    if print_only:
        ...
        if len(gpu_list) > 1 and not is_worker:
            ...
            from vggt.models.depth_anything_3.api import DepthAnything3
