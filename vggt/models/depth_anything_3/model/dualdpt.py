...
from vggt.models.depth_anything_3.model.dpt import _make_fusion_block, _make_scratch
from vggt.models.depth_anything_3.model.utils.head_utils import (
    Permute,
    create_uv_grid,
    custom_interpolate,
...
class DualDPT(nn.Module):
    ...
    #     self.scratch.output_conv2_aux = self.scratch.output_conv2_aux.to(*args, **kwargs)
    #     return self
    ...
    def _forward_impl(
        ...
        for stage_idx, take_idx in enumerate(self.intermediate_layer_idx):
            x = feats[take_idx][:, patch_start_idx:].float()
            x = self.norm(x)
