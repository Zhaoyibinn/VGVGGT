...
class PointNetFeaturePropagation(nn.Module):
    def __init__(self, in_channel, out_channel, blocks=1, groups=1, res_expansion=1.0, bias=True, activation='relu', batch_norm=True):
...
class PointMLPEncoder(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 ...
                 preserve_input_dim=False, stage_dims=None, **kwargs):
        """
...
def pointMLPEncoderBasezyb1(feature_channel=3, num_classes=50, batch_norm=True, output_dim=2048, **kwargs) -> PointMLPEncoder:
    ...
    return PointMLPEncoder(num_classes=num_classes, points=2048, embed_dim=None, groups=1, res_expansion=1.0,
                 ...
                 preserve_input_dim = True, **kwargs)
